...
At 09:00 pick mode via the 15-second chooser. Write one Strike using the template. Start a 25-min timer.

Produce exactly one artifact.

At 21:00 log artifacts, 1-line energy note, and pre-write tomorrow’s Strike.


Definition of done (Step 2)

You picked a mode in ≤15 seconds.

You executed one Strike with a clear stop.

You produced one artifact and logged it.


Pitfalls to ignore: fancy tags, better timers, prettier templates. Those are Step 6 problems for Future You, who will certainly be wiser and definitely not just as distractible.

Good. You’re excited; let’s bottle that before your brain sprints off to reorganize the spice drawer.

Askirom v11 — Step 2/5: Modes + Strike (runnable)
