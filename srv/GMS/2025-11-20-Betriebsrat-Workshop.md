...
* **Situation:** Externe Admins haben oft weitreichende Rechte ("God Mode").
* **Fragen an den BR:**
...
* **Das Spannungsfeld:**
    * Für DAkkS muss man wissen: *Wer* hat kalibriert? (Traceability).
    * Für den Datenschutz gilt: Keine Leistungskontrolle ohne Rechtsgrundlage/BV.
* **Die Gefahr:**
    * Aus den Protokollen lassen sich Leistungsprofile erstellen ("Wer schafft wie viele Geräte?").
* **Diskussion:**
    * Werden solche Zahlen offen kommuniziert? (Aushänge, Team-Meetings)
    * Gibt es Vorgabezeiten für Reparaturen, die im System getrackt werden?
