...
•      **Minimierung von Risiken:** Durch einen strukturierten Ansatz können potenzielle Risiken frühzeitig identifiziert und bewertet werden, was hilft, negative Auswirkungen auf den Betrieb zu minimieren.

•      **Verbesserte Kontrolle:** Ein formalisierter Change-Management-Prozess sorgt für klare Verantwortlichkeiten und Genehmigungswege, was die Kontrolle über Änderungen erhöht.

•      **Erhöhte Transparenz:** Dokumentation und Nachverfolgbarkeit jeder Änderung fördern die Transparenz und helfen bei der Ursachenanalyse im Falle von Problemen.

•      **Kontinuierliche Verbesserung:** Durch die regelmäßige Überprüfung und Bewertung von Änderungen können Erkenntnisse gewonnen werden, die zur kontinuierlichen Verbesserung von Prozessen und Systemen beitragen.

•      **Sicherstellung der Compliance:** Ein strukturierter Prozess hilft dabei, gesetzliche und regulatorische Anforderungen einzuhalten, indem er sicherstellt, dass alle Änderungen dokumentiert und nachverfolgt werden.

•      **Optimierte Ressourcennutzung:** Durch sorgfältige Planung und Priorisierung können Ressourcen effizienter genutzt und Engpässe vermieden werden.

•      **Steigerung der Servicequalität:** Ein gut verwalteter Change-Management-Prozess trägt dazu bei, die Qualität und Zuverlässigkeit der IT-Dienste zu verbessern, was letztlich die Zufriedenheit der Endanwender erhöht.
...
•      **Abteilungs-/Bereichsleitung IT**[[JE1]](#_msocom_1) : Die Abteilungs-/Bereichsleitung IT ist für die Genehmigung aller IT-Änderungen verantwortlich. Er übernimmt die Aufgaben des Change Advisory Boards (CAB) und sorgt für die ordnungsgemäße Umsetzung und Dokumentation aller Changes. Zusätzlich ist die Abteilungs-/Bereichsleitung IT verantwortlich für die Einhaltung dieser Change-Richtlinie.

•      **IT-Abteilung**: Die IT-Abteilung ist für die tatsächliche Umsetzung der genehmigten Changes verantwortlich. Dies umfasst die Planung, Durchführung und Überwachung der Implementierung sowie die Sicherstellung, dass alle Änderungen ordnungsgemäß getestet und dokumentiert werden.

•      **Fachabteilungen**[[JE2]](#_msocom_2) [[RL3]](#_msocom_3) : Die Fachabteilungen sind für die Einreichung von Change-Anträgen und die Bereitstellung aller notwendigen Informationen zur Bewertung und Umsetzung der Changes verantwortlich. Sie unterstützen die IT-Abteilung und den IT-Leiter bei der Analyse der Auswirkungen und der Planung der Implementierung.

◦       **Sonderfall**: Die IT-Abteilung fungiert sowohl in der Rolle als Fachabteilung als auch in ihrer eigenen Rolle.
...
·       **Routineaufgaben:** Umfasst Aufgaben wie Passwortzurücksetzungen, Benutzerzugriffsanfragen (Teams / Gruppenlaufwerke), einfache Softwareinstallationen oder Standardwartungen.

·       Es **findet keine technische oder strukturelle Änderung** an der IT-Infrastruktur oder an Services statt.

·       **Geringes Risiko:** Es werden keine signifikanten Systemänderungen vorgenommen, wodurch das Risiko für den laufenden Betrieb minimal ist.

·       **Keine Risikobewertung** oder Genehmigung erforderlich.
...
·       Anforderung eines Laptops für neuen Mitarbeitenden
...
·       **Systemische Änderungen:** Beinhaltet Modifikationen, Erweiterungen oder Neugestaltungen, die den Status quo der IT-Umgebung verändern.

·       **Höheres Risiko:** Aufgrund der möglichen weitreichenden Auswirkungen ist eine sorgfältige Planung, Risikobewertung und ein formeller Genehmigungsprozess erforderlich.

·       **Ausführlicher Ablauf:** Umfasst detaillierte Änderungsanträge, umfassende Tests, eine dokumentierte Genehmigung und klare Rollbacks im Notfall.

**Beispiele:**

o   Änderungen an Netzwerkkonfigurationen

o   Implementierung neuer Funktionalitäten in kritischen Systemen

o   System-Upgrades oder größere Hardware-Austausche
...
•      **Prozess:** Ein standardisierter und wiederholbarer Prozess, der nur minimale Abweichungen zulässt.
...
•      **Prozess:** Detaillierte Beschreibung, Bewertung der betroffenen Systeme, klar definierter Genehmigungsprozess und festgelegte Testverfahren.

•      **Genehmigung:** Genehmigungsprozess ist einzuhalten
...
•      **Prozess:** Schnelle Umsetzung, oft tatsächliche Zeitrahmen, Rückfallplan vorhanden.
...
|**Hoch (H)**|- Eine große Anzahl von Mitarbeitern ist / kann betroffen sein und/oder kann ihre Aufgaben nicht erfüllen.<br>- Eine große Anzahl von Kunden ist betroffen und/oder ist in irgendeiner Weise akuten Nachteilen ausgesetzt.|
...
•      **Erfassung im Ticketsystem**: Alle Change-Anträge müssen im internen Ticketsystem erfasst werden. Dies ermöglicht eine zentrale Verwaltung und Nachverfolgbarkeit aller Änderungen.

•      **Vollständigkeit der Felder**: Das Ticketsystem enthält alle notwendigen Felder, die für die Erfassung einer Change-Anforderung erforderlich sind. Dazu gehören unter anderem:

o   Beschreibung der Änderung

o   Begründung der Änderung

o   Auswirkungen und Risiken

o   Dringlichkeit und Priorität

o   Betroffene Systeme und Abteilungen

o   Geplante Umsetzungstermine

o   Test- und Validierungsverfahren

•      **Dokumentation im Ticketsystem**: Alle relevanten Dokumentationen, wie Planungsdokumente, Testprotokolle und Genehmigungen, müssen im Ticketsystem hinterlegt werden. Dies stellt sicher, dass alle Informationen an einem zentralen Ort verfügbar sind und jederzeit eingesehen werden können.

•      **Zugriff und Transparenz**: Der Zugriff auf die Change-Anträge und die zugehörige Dokumentation im Ticketsystem ist für alle beteiligten Rollen (IT-Leiter, IT-Abteilung, Fachabteilungen) gewährleistet. Dies fördert die Transparenz und Zusammenarbeit im gesamten Change-Management-Prozess.
...
·       Die Abteilungs-/Bereichsleitung IT genehmigt oder lehnt den Change-Antrag ab.
...
•      Alle Tests und Ergebnisse werden im Ticketsystem dokumentiert.
...
·       Formel: (Erfolgreiche Changes / Gesamtzahl der Changes) x 100
...
·       Formel: (Fehlgeschlagene Changes / Gesamtzahl der Changes) x 100
...
·       Formel: Summe der Durchlaufzeiten aller Changes / Anzahl der Changes
...
·       Formel: (Anzahl der Notfall-Changes / Gesamtzahl der Changes) x 100
...
·       Formel: Anzahl offener Changes am Ende des Berichtszeitraums - Anzahl offener Changes am Anfang des Berichtszeitraums
...
·       Formel: (Anzahl der Changes mit vollständiger Dokumentation / Gesamtzahl der Changes) x 100
...
·       Formel: Summe aller implementierten Changes im Berichtszeitraum
...
·       Formel: Summe der Genehmigungszeiten / Anzahl der genehmigten Changes
...
·       Die IT-Abteilung ist für die Datenerhebung verantwortlich.

·       Die Abteilungs-/Bereichsleitung IT führt die Auswertung der KPIs durch.
...
o   Eine Übersicht aller KPIs mit aktuellen Werten und Trends

o   Analyse der Abweichungen von Zielwerten

o   Identifizierte Verbesserungspotenziale

o   Vorgeschlagene Maßnahmen zur Prozessoptimierung
...
·       An diesem Meeting nehmen teil: Abteilungs-/Bereichsleitung IT, Vertreter der IT-Abteilung und ggf. Vertreter der Fachabteilungen.

·       Basierend auf den Ergebnissen und Erfahrungen des vergangenen Jahres können KPIs angepasst, hinzugefügt oder entfernt werden.

·       Zielwerte können bei Bedarf neu definiert werden, um die kontinuierliche Verbesserung des Change-Management-Prozesses zu fördern.
...
·       Bei Abweichungen von Zielwerten werden Ursachenanalysen durchgeführt und Verbesserungsmaßnahmen eingeleitet.

·       Erfolgreiche Verbesserungsmaßnahmen werden dokumentiert und in den Change-Management-Prozess integriert.

·       Die Wirksamkeit der Verbesserungsmaßnahmen wird anhand der Entwicklung der relevanten KPIs überprüft.

---

 [[JE1]](#_msoanchor_1)IT-Leiter

 [[JE2]](#_msoanchor_2)z.B. IAF, Lehrbeauftragung, wie ist das mit PRIMUSS-getriebenen Änderungen?

 [[RL3]](#_msoanchor_3)Institute der Hochschule

 [[JE4]](#_msoanchor_4)Gehört da jedes Server-Update dazu?

Dann ist das sehr aufwändig und zeitraubend.

 [[JE5]](#_msoanchor_5)Mit Herrn Lackus besprechen. Passende Change-Ticket-Vorlage nicht vorhanden.

 [[RL6]](#_msoanchor_6)Anpassen für EH Freiburg