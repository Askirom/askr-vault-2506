...
### Anwendungsbereich
Diese Richtlinie gilt für alle IT-Systeme, Anwendungen und Datenbanken der Organisation sowie für alle Mitarbeitenden und Dienstleistenden, die Zugang zu sensiblen Daten haben.

### Zielsetzung
Die Hauptziele der Datenmaskierung sind:
- Minimierung des Risikos eines Datenmissbrauchs.
- Reduktion des Risikos der Offenlegung von sensiblen Daten
...
Die Organisation verwendet je nach Bedarf unterschiedliche Datenmaskierungstechniken:
- **Pseudonymisierung:** Ersetzt identifizierende Daten durch Aliase. Die zusätzlichen Informationen, die für eine Rückidentifizierung notwendig sind, werden getrennt und sicher aufbewahrt.
...
- **Freigabe:** Die Maßnahmen werden erst nach Zustimmung durch die Geschäftsleitung implementiert.

### Regelmäßige Überprüfung
Der DSB und ISB führen regelmäßig Audits durch, um sicherzustellen, dass die Maskierungsmaßnahmen wirksam und datenschutzkonform sind. Dabei werden potenzielle Risiken neu bewertet und Maßnahmen angepasst.